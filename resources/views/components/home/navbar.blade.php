<nav class="navbar navbar-expand-md navbar-light">
   ...
   <img src="{{ asset('assets/img/logo.png') }}" class="logo-one" alt="Logo" width="80" height="80">
   <img src="{{ asset('assets/img/logo.png') }}" class="logo-two" alt="Logo" width="80" height="80">
   </a>
